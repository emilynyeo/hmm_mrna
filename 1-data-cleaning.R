...
rda_out <- "Z:/ADORLab/__Users/elji2394/HMO-miRNA/1-data-cleaning/rda/"

#figs_out for any figures or tables
figs_out <- "Z:/ADORLab/__Users/elji2394/HMO-miRNA/1-data-cleaning/figs/"

# read in the miRNA data
#counts per million for use when miRNA is the predictor
miRNA_cpm <- read.csv("Z:/ADORLab/Master Mothers Milk Data Folder/Breast Milk miRNAs/Alderette-Goran EV Pilot/Datasets for Analysis/MOM155 Removed/RNAs in 70perc of Samples/Counts per Million/210914_Alderette_Goran_exceRpt_70perc_expr_miRNAs_TMMnormalized_CPM_MOM155removed.csv")
#QC file contains important control variables
miRNA_QC <- read.csv("Z:/ADORLab/Master Mothers Milk Data Folder/Breast Milk miRNAs/Alderette-Goran EV Pilot/Batch Files/Goran_Alderette_Pilot_9-2021_Batch_Info_Combined.csv")
#raw counts for use when miRNA is the outcome
miRNA_counts <- read.csv("Z:/ADORLab/Master Mothers Milk Data Folder/Breast Milk miRNAs/Alderette-Goran EV Pilot/Datasets for Analysis/MOM155 Removed/RNAs in 70perc of Samples/Raw Counts/210914_Alderette_Goran_exceRpt_70perc_expr_miRNAs_TMMnormalized_RawCounts_MOM155removed.csv")

# read in the unfiltered miRNA data frame
miRNA_all <- read.csv("Z:/ADORLab/Master Mothers Milk Data Folder/Breast Milk miRNAs/Alderette-Goran EV Pilot/Datasets for Analysis/MOM155 Removed/All RNAs Detected/Raw Counts/210914_Alderette_Goran_exceRpt_miRNAs_TMMnormalized_RawCounts_MOM155removed.csv")

# the first row and last 2 rows are not miR, the rest are
# 1219 - 3 = 1216

#read in the meta data
meta <- read.csv("Z:/ADORLab/HEI Study/Master Datasets/Metadata/long/mothersMilk_metadata_timepointsAsRows_updated101921_Temporary24mDiet.csv")
...
#join in the QC variables to miRNA_t
miRNA_counts <- left_join(miRNA_counts, miRNA_QC_sub, by = "Sample_ID")
...
sum(miRNA_counts$LibSize)
# get average reads per sample
